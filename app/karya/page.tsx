...
export const metadata: Metadata = {
  title: "Semua Karya — Pixels to Reality",
  description:
      ...
      <div className="w-full max-w-5xl">
        <header className="mb-10 text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-base text-white/90 sm:text-lg">
            Direktori lengkap seluruh karya pameran: Game, Website, Software, IoT &amp; Hardware, serta Digital Art karya siswa RPL.
          </p>
        </header>

        <section
          aria-label="Karya Directory Skeleton"
        ...
        >
          <div className="mx-auto max-w-md space-y-4">
            ...
            <h2 className="font-display text-2xl text-white sm:text-3xl">
              Karya Showcase Section
            </h2>
            <p className="text-sm leading-relaxed text-white/70">
              Struktur route siap untuk integrasi kategori karya, showcase grid, detail karya, dan sistem voting pada phase berikutnya.
            </p>
          </div>
        </section>
      </div>
