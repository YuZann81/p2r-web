  ...
  return (
    ...
    >
      <div className="w-full max-w-5xl">
        ...
        <section
          aria-label="Leaderboard Skeleton"
        ...
        >
          <div className="mx-auto max-w-md space-y-4">
            ...
            <h2 className="font-display text-2xl text-white sm:text-3xl">
              Arcade &amp; Karya Rankings
            </h2>
            <p className="text-sm leading-relaxed text-white/70">
              Struktur route siap untuk integrasi klasemen skor game per kategori dan ranking perolehan vote karya pada phase berikutnya.
            </p>
          </div>
        </section>
      </div>
