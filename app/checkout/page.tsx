    ...
    return (
      <div className="mx-auto w-full max-w-3xl rounded-3xl border-2 border-white/20 bg-[#1e1040] p-5 sm:p-8 text-center shadow-2xl animate-in fade-in">
        ...
        <div className="mt-6 flex flex-col sm:flex-row justify-center gap-3">
          <Link
            href="/orders"
            className="inline-flex min-h-[42px] items-center justify-center gap-1.5 rounded-xl bg-arcade-yellow px-6 py-2.5 font-display text-sm font-bold text-arcade-ink shadow-md transition-transform hover:-translate-y-0.5"
          >
