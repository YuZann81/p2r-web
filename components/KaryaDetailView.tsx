      ...
      <div className="mx-auto w-full max-w-5xl">
        ...
        <header className="mb-10 text-center md:mb-14">
          ...
          <div className="mt-4 flex items-center justify-center gap-3">
            <span className="inline-block rounded-md border border-arcade-yellow/50 bg-[#1e1040] px-3.5 py-1 font-display text-xs font-bold uppercase tracking-wider text-arcade-yellow sm:text-sm">
              {categoryLabel}
            </span>
            {karya.votes_count > 0 && (
              <span className="inline-flex items-center gap-1.5 rounded-md border border-white/20 bg-black/60 px-3.5 py-1 font-mono text-xs font-bold text-white sm:text-sm">
                <span>VOTES:</span>
        ...
        <section aria-label={`Detail Karya ${karya.title}`} className="w-full">
          <div className="grid grid-cols-1 items-start gap-8 md:grid-cols-2 md:gap-12">
            ...
            {/* Right Column: Description, Tech Stack, & Actions */}
            <div className="flex flex-col gap-6 rounded-2xl border-2 border-white/20 bg-[#1e1040] p-6 shadow-[6px_6px_0_var(--arcade-ink)] sm:p-8">
              <div>
              ...
              {techStackList.length > 0 && (
                <div>
                  <h3 className="font-display text-sm uppercase tracking-wider text-arcade-yellow sm:text-base">
                    Tech Stack &amp; Tools
                  </h3>
              ...
              <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
                {karya.live_url && (
                  ...
                  >
                    <span>Mainkan / Buka Live Demo</span>
